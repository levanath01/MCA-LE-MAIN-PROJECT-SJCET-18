...
<form class="pure-form pure-form-stacked" action="" method="post">
 ...
 <h2 class="content-subhead">18.What the mentee wants to achieve in life</h2>
 <fieldset>
<table class="pure-table pure-table-horizontal">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            <td>#</td>
            <td><input id="email" type="text" placeholder=""name="goal_perso"></td>
            <td><input id="email" type="text" placeholder=""name="goal_prof"></td>
            <td><input id="email" type="text" placeholder=""name="goal_soc"></td>
