...
<form class="pure-form pure-form-stacked" action="" method="post">
 ...
 ?>
	...
	<h2 class="content-subhead">Hobbies</h2>
 <fieldset>
<table class="pure-table pure-table-horizontal">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            <td>#</td>
            <td><input id="email" type="text" placeholder=""name="hob_phy"></td>
            <td><input id="email" type="text" placeholder=""name="hob_advent"></td>
            <td><input id="email" type="text" placeholder=""name="hob_soft"></td>
