...
//$sql="SELECT `uni_id` FROM `university` WHERE `uni_email`='$username'";
//$result=mysqli_query($con,$sql);
	//$row=mysqli_fetch_array($result);
	//$uvid=$row['uni_id'];
  
  
		$sql="SELECT * FROM `tbl_mentor` WHERE `mentor_uname`='$username'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					//$username=$_SESSION['username'];
					$user5="SELECT * FROM `tbl_mentor` WHERE  mentor_uname='$username'"; 
	 ...
	 while($row5=mysqli_fetch_assoc($r5))
		...
		<?php				  
                      ...
                      <ul class="list-unstyled user_data">
					   ...
					   <a class="btn btn-success" href="mentor_profile_edit.php?action=edit&id=<?php echo $mnid; ?>"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">My Students</a>
                          </li>
...
//echo"<tr><td>".$row['uni_id']."</td>";
		...
		?>	
                          ...
                          <td>
                            <a href="mentor_user_profile_view.php?action=edit&id=<?php echo $id2; ?>" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View Profile </a>
