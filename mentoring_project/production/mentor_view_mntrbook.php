			...
			if(isset($_GET['action']))
{
 ...
 <?php
 $sql33="SELECT count(*) FROM `tbl_mn_biodata` WHERE `bio_stud_id`='$id'";
		$r33= mysqli_query($con,$sql33);
			$value = mysqli_fetch_assoc($r33);
			$int = (int)$value;
...
<td>&nbsp;
  ...
  <td class="project_progress">
                            <div class="progress progress_sm">
                              <div class="progress-bar bg-blue" role="progressbar" data-transitiongoal="<?php echo $int; ?>"></div>
                            </div>
                            <small><?php echo $int; ?>% Complete</small>
                          </td></tr>
</table>
                    ...
                    <!-- end project list -->
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="mentor_view_book/biodata_section.php?action=edit&id=<?php echo $sid; ?>" class="btn btn-default btn-sm"><i class="fa fa-edit m-right-xs"></i>Biodata Of Mentee</a>
                          </td>
						  ...
						  <a href="mentor_view_book/objective_impr.php?action=edit&id=<?php echo $sid; ?>" class="btn btn-default btn-sm"><i class="fa fa-edit m-right-xs"></i>Mentors Objective Impressions About Mentee</a>
						...
						<tr>
                          ...
                          <td>
                             <a href="mentor_view_book/annexure1.php?action=edit&id=<?php echo $sid; ?>" class="btn btn-default btn-sm"><i class="fa fa-edit m-right-xs"></i>Annexure 1</a>
                          </td>
