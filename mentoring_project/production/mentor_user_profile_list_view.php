                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
		                     ...
		                     <img class="img-responsive avatar-view" src="<?php echo $sphoto;?>" alt="Mentor Photo" title="Change the avatar">
                      ...
                      <ul class="list-unstyled user_data">
					   ...
					   <a class="btn btn-success" href="univ_profile_edit.php"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
