                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <ul class="list-unstyled user_data">
					   ...
					   <a class="btn btn-success" href="mentor_edit_student.php?action=edit&id=<?php echo $sid; ?>"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
					   <a class="btn btn-success" href="mentor_student_photo_upload.php?action=upload&id=<?php echo $sid; ?>"><i class="fa fa-edit m-right-xs"></i>Upload Photo</a>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <td>
                           &nbsp;&nbsp;&nbsp;&nbsp; <a href="mentor_view_mntrbook.php?action=edit&id=<?php echo $sid; ?>" class="btn btn-primary"><i class="fa fa-folder"></i> View Mentoring Book </a>
			</td>
			 <td>
                           &nbsp;&nbsp;&nbsp;&nbsp; <a href="mentor_mentoring_start.php?action=edit&id=<?php echo $sid; ?>" class="btn btn-primary"><i class="fa fa-folder"></i> Fill  Mentoring Book </a>
			</td>
