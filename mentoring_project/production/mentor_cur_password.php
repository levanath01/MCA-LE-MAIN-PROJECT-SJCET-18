            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form name="frmChange" action="mentor_cur_pass_confirm.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"onSubmit="return validatePassword()">
					...
					-->  
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-primary" onclick="javascript:window.location='mentor_home.php';"type="button">Cancel</button>
