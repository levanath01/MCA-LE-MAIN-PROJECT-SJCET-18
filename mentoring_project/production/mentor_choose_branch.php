...
<!-- page content -->
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="mentor_user_profile_list.php" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
 ...
 <div class="input-group">
                             <select type="text" name="studcourse" class="form-control">
...
//echo"<tr><td>".$row['uni_id']."</td>";
		...
		?>
                            ...
                            <span class="input-group-btn">
											  ...
											  &nbsp;<button type="submit" class="btn btn-success" Onclick="">Select</button>
                                          </span>
                          </div>
