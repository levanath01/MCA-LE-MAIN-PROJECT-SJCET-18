...
<form class="pure-form pure-form-stacked" action="" method="post">
 ...
 <input type="hidden" name="stuid" value="<?php echo $stid;?>" >   
                ...
                <input id="character"  type="text"  placeholder="" name="charac" value="<?php echo $row["charac"]; ?>"readonly="readonly"/>
            
                <label>b)Personalityonality</label>
                <input id="personality"  type="text"  placeholder="" name="persona"  value="<?php echo $row["persona"]; ?>"readonly="readonly"/>
          
                <label>c)Impressiveness</label>
                <input type="text"  placeholder=""name="impressiv" value="<?php echo $row["impressiv"]; ?>"readonly="readonly" >
	...
	<input id="nri_parents" type="radio" name="	srcnri" value="Yes" <?php echo $row["srcnri"] == "Yes" ? 'checked="checked"' : ''; ?> >Yes
        ...
        <textarea   placeholder="Text" name="loan"value="<?php echo $row["loan"]; ?>"readonly="readonly">
		</textarea>
	
		
		<label for="fee_concession">c)Fee concession,if any,received(from management)</label>
        <input id="fee_concession" type="text" placeholder="" name="concession"value="<?php echo $row["concession"]; ?>"readonly="readonly">
	
	
		<label for="scholership">d)Scholarship,if any,received,specify the amount received</label>
         <textarea   placeholder="Text" name="scholarship"value="<?php echo $row["scholarship"]; ?>"readonly="readonly">
		</textarea>
...
<input id="prntl_hrmy" type="text" placeholder=""name="	pharmony"value="<?php echo $row["pharmony"]; ?>"readonly="readonly">
<label for="personality">31.Relationship with parents & siblings:</label>
<input id="reltnshp" type="text" placeholder=""name="prel"value="<?php echo $row["prel"]; ?>"readonly="readonly">
<label for="atms">32.Atmosphere/support at home for studies:</label>
<input id="atms" type="text" placeholder=""name="	atmosphere"value="<?php echo $row["atmosphere"]; ?>"readonly="readonly">
<label for="reli">33.Religious life/atrtitude towards ethics and morality:</label>
<input id="reli" type="text" placeholder=""name="religious"value="<?php echo $row["religious"]; ?>"readonly="readonly">
<label for="socio">34.Socio-political outlooks(identify party affilation ,if any):</label>
<input id="socio" type="text" placeholder=""name="	political"value="<?php echo $row["political"]; ?>"readonly="readonly">
<label for="rdng">35.Reading habits(Name the Newspaper/Magazines the mentee usually reads:</label>
<input id="rdng" type="text" placeholder=""name="	reading"value="<?php echo $row["reading"]; ?>"readonly="readonly">
...
<input id="bhv" type="text" placeholder="" name="	behaviour"value="<?php echo $row["behaviour"]; ?>"readonly="readonly">
<label for="prntl_hrmy">37.Potentials (Skill) of the mentee (Identify those correctly):</label>
 <textarea   placeholder="Text" name="	potential"value="<?php echo $row["potential"]; ?>"readonly="readonly">
		</textarea>
		</fieldset>
...
<input id="atms" type="text" placeholder=""name="	weakness"value="<?php echo $row["weakness"]; ?>"readonly="readonly">
<label for="atms">39.Adjustment of classs/college/hostel environment(Specify the extent):</label>
 <textarea   placeholder="Text"name="adjustment"value="<?php echo $row["adjustment"]; ?>"readonly="readonly">
		</textarea>
<label for="prntl_hrmy">40.Addiction to habbits(Strictly Note):</label>
<textarea   placeholder="Text"name="addiction"value="<?php echo $row["addiction"]; ?>"readonly="readonly">
		</textarea>
<label for="prntl_hrmy">41.Improvement areas:</label>
<textarea   placeholder="Text"name="	improvement"value="<?php echo $row["improvement"]; ?>"readonly="readonly">
		</textarea>
<label for="prntl_hrmy">42. A)Specify concers of the mentee as assured by the mentor:</label>
a)<input id="atms" type="text" placeholder=""name="concern1"value="<?php echo $row["concern1"]; ?>"readonly="readonly">
b)<input id="atms" type="text" placeholder=""name="concern2"value="<?php echo $row["concern2"]; ?>"readonly="readonly">
...
<input id="rmy" type="text" placeholder=""name="	fitness"value="<?php echo $row["fitness"]; ?>"readonly="readonly">
<label for="goal">44.Life Goals set(to be set) by the Mentee:</label>
<input id="goal" type="text" placeholder=""name="	goals"value="<?php echo $row["goals"]; ?>"readonly="readonly">
