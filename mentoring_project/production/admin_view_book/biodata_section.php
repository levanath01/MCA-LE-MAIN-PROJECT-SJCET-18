...
<form class="pure-form pure-form-stacked" action="" method="post">
 ...
 <div class="pure-u-1 pure-u-md-1-3">
  <input type="hidden" name="stuid" value="<?php echo $stid;?>" >   
                ...
                <input id="first-name" class="pure-u-23-24" type="text" name="mname" value="<?php echo $sname;?>"readonly="readonly">
            </div>
        ...
        <div class="pure-g">
            ...
            <div class="pure-u-1 pure-u-md-1-3">
                ...
                <input id="last-name" class="pure-u-23-24" type="date" name="mdob" value="<?php echo $sdob;?>"readonly="readonly">
            </div>

            <div class="pure-u-1 pure-u-md-1-3">
                <label for="email">Age</label>
                <input id="email" class="pure-u-23-24" type="text" name="mage" value="<?php echo $sage;?>"readonly="readonly">
            </div>

            <div class="pure-u-1 pure-u-md-1-3">
                <label for="city">Blood Group</label>
                <input id="city" class="pure-u-23-24" type="text"name="mbgrp" value="<?php echo $sbgrp;?>"readonly="readonly">
            </div>
			...
			<div class="pure-u-1 pure-u-md-1-3">
                ...
                <input id="city" class="pure-u-23-24" type="text"name="mrelg" value="<?php echo $srelg;?>"readonly="readonly">
            </div>
			<div class="pure-u-1 pure-u-md-1-3">
                <label for="city">Caste</label>
                <input id="city" class="pure-u-23-24" type="text"name="mcst" value="<?php echo $scaste;?>"readonly="readonly">
            </div>
			<div class="pure-u-1 pure-u-md-1-3">
                <label for="city">If catholic specify diocese/parish</label>
                <input id="city" class="pure-u-23-24" type="text"name="mparish" value="<?php echo $sparish;?>"readonly="readonly">
            </div>
            ...
            <textarea class="pure-input-1-2" placeholder="Text"name="maddrs" value="<?php echo $saddrs;?>"readonly="readonly"></textarea>
            </div>

			<div class="pure-u-1 pure-u-md-1-3">
                <label for="city">Email</label>
                <input id="city" class="pure-u-23-24" type="email" name="memail" value="<?php echo $smail;?>"readonly="readonly">
            </div>
			<div class="pure-u-1 pure-u-md-1-3">
                <label for="city">Contact No.</label>
                <input id="city" class="pure-u-23-24" type="text"name="mmob" value="<?php echo $smob;?>"readonly="readonly">
            </div>
	...
	<input id="nri_parents" type="radio" name="hostel" value="Yes" <?php echo $hostel == "Yes" ? 'checked="checked"' : ''; ?> >Yes
        ...
        <input id="email" type="text" placeholder=""name="mnstay"value="<?php echo $stay;?>"readonly="readonly">
		<label for="email">*The mode of conveyance</label>
        <input id="email" type="text" placeholder=""name="mnconvey"value="<?php echo $convey;?>"readonly="readonly">
...
<table class="pure-table pure-table-horizontal">
    ...
    <tbody>
        <tr>
            ...
            <td><input id="email" type="text" placeholder=""name="mnorg"value="<?php echo $morg;?>"readonly="readonly"></td>
            <td><input id="email" type="text" placeholder=""name="mnjob"value="<?php echo $mjob;?>"readonly="readonly"></td>
            <td><input id="email" type="text" placeholder=""name="mnjdur"value="<?php echo $mdur;?>"readonly="readonly"></td>
			<td><input id="email" type="text" placeholder=""name="mnrespo"value="<?php echo $mrespo;?>"readonly="readonly"></td>
        </tr>
...
<label for="email">Mentees Role Model</label>
        ...
        <input id="email" type="text" placeholder=""name="mnrolemdl"value="<?php echo $mrole;?>"readonly="readonly">
