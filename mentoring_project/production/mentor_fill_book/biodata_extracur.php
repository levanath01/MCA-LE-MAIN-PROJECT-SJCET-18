...
<form class="pure-form pure-form-stacked" action="" method="post">
 ...
 ?>
	 ...
	 <h2 class="content-subhead">15.Extracurricular activities with recognition/proficiency</h2>	
		<fieldset>
<table class="pure-table pure-table-horizontal">
    <thead>
        <tr>
    ...
    <tbody>
        <tr>
            ...
            <td><input id="email" type="text" placeholder=""name="culact"></td>
            <td><input id="email" type="text" placeholder=""name="lvlrecog"></td>
            <td><input id="email" type="date" placeholder=""name="actyear"></td>
			<td><input id="email" type="text" placeholder=""name="actrmrk"></td>
        </tr>
