...
if(isset($_GET['action']))
{
	...
	$sq1="DELETE FROM `tbl_branch` WHERE sc_id='$id'";
...
<div class="right_col" role="main">
	...
	$sql="SELECT * FROM `student_course` where sc_studemail='$username'";
...
//echo"<tr><td>".$row['uni_id']."</td>";
			echo"<td>".$row['sc_coursename']."</td>";
	        echo"<td>".$row['sc_jdate']."</td>";
			echo"<td>".$row['sc_edate']."</td>";
		...
		?>	
                          ...
                          <td>
                            ...
                            <a href="user_study_course.php?action=delete&id=<?php echo $id1; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> UnEnroll </a>
                          </td>
                        </tr>
						<?php
					 }
